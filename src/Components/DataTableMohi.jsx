  ...
  const data = [
    {
      ...
      size: "500 KB",
      language: "English",
      viewLink: "/All_Pdf/MOHI/Final Battery Swapping and Charging Guidelines 2024 (1).pdf", // Local path
    },
    {
      srNo: 2,
      title: "Ammend 2",
      ...
      size: "975 KB",
      language: "English",
      viewLink: "/All_Pdf/MOHI/Guidelines_and_Standards_for_EVCI_dated_17_09_2024 (1).pdf", // Local path
    },
    {
      srNo: 3,
      title: "Noti",
      ...
      size: "1615 KB",
      language: "English",
      viewLink: "/All_Pdf/MOHI/MBBL 2016 (1).pdf", // Local path
    },
  ];
